...
fileName = "TVerburgE10_1Processed.csv";
arduinoFileName = "FinalE10_1.txt";
...
subSecMeasuredTension = measuredTension(3402:10000) - measuredTension(1);
...
grt3 = nexttile;
plot(t, (ssArduinoData(:, 2)) - (Ft./(SRdz +0.05)))
